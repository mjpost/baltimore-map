...
Then, run the script, pointing it to a YAML configuration file:

    python3 baltimore.py --data-file visit.yaml
...
Can be found in the `maps/` directory, including different version of the Baltimore map.
